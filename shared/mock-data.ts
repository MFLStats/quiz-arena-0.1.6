...
export const MOCK_SHOP_ITEMS: ShopItem[] = [
  // Avatars - Curated & Diverse
  {
    ...
    rarity: 'common',
    price: 50,
    assetUrl: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Felix&backgroundColor=b6e3f4',
    description: 'A futuristic look for the digital age.'
  },
  {
    id: 'av_2',
    name: 'Neon Ninja',
    ...
    rarity: 'rare',
    price: 200,
    assetUrl: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Aneka&backgroundColor=c0aede',
    description: 'Stealth and style combined.'
  },
  {
    id: 'av_3',
    name: 'Space Explorer',
    ...
    rarity: 'epic',
    price: 500,
    assetUrl: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Christopher&backgroundColor=ffdfbf',
    description: 'Ready for the final frontier.'
  },
  {
    id: 'av_4',
    name: 'Golden Legend',
...
# Phase 96: Visual Polish & Asset Overhaul
## File 1: shared/mock-data.ts
```typescript
# Updating MOCK_SHOP_ITEMS with enhanced visual assets (avatars and frames)
cat > shared/mock-data.ts << 'EOF'
import type { Category, Question, User, ShopItem } from './types';
const TODAY = new Date().toISOString().split('T')[0];
// Helper to generate random activity map for the last 90 days
const generateActivityMap = () => {
...
export const MOCK_SHOP_ITEMS: ShopItem[] = [
  ...
  },
  {
    ...
    rarity: 'legendary',
    price: 1000,
    assetUrl: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Jack&backgroundColor=ffd5dc',
    description: 'The ultimate status symbol.'
  },
  // Christmas Items
  {
    ...
    rarity: 'legendary',
    price: 1200,
    assetUrl: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Santa&top=winterHat2&hairColor=silverGray&facialHair=beardMajestic&clothing=collarAndSweater&clothingColor=red&backgroundColor=d1d4f9',
    description: 'Ho ho ho! Merry Christmas!'
  },
  {
    id: 'av_elf',
    ...
    rarity: 'epic',
    price: 600,
    assetUrl: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Elf&top=winterHat1&clothing=collarAndSweater&clothingColor=pastelGreen&backgroundColor=b6e3f4',
    description: 'Santa\'s little helper.'
  },
  // Banners
  {
